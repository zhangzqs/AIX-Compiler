...
public enum ComponentCategory {
	// TODO(user): i18n category names
	USERINTERFACE("User Interface"), LAYOUT("Layout"), MEDIA("Media"), ANIMATION("Drawing and Animation"), MAPS("Maps"),
	SENSORS("Sensors"), SOCIAL("Social"), STORAGE("Storage"), CONNECTIVITY("Connectivity"),
	LEGOMINDSTORMS("LEGO\u00AE MINDSTORMS\u00AE"), EXPERIMENTAL("Experimental"), EXTENSION("Extension"),
	INTERNAL("For internal use only"),
	// UNINITIALIZED is used as a default value so Swing libraries can still compile
	UNINITIALIZED("Uninitialized");

	// Mapping of component categories to names consisting only of lower-case
	// letters,
	// suitable for appearing in URLs.
	private static final Map<String, String> DOC_MAP = new HashMap<String, String>();
	static {
	...
	/**
	 * Returns the display name of this category, as used on the Designer palette,
	 * such as "Not ready for prime time". To get the enum name (such as
	 * "EXPERIMENTAL"), use {@link #toString}.
	 *
