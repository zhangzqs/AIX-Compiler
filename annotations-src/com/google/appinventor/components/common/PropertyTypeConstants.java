...
public class PropertyTypeConstants {
	...
	/**
	 * Minimum distance interval, in meters, that the location sensor will try to
	 * use for sending out location updates. See
	...
	/**
	 * Minimum time interval, in milliseconds, that the location sensor use to send
	 * out location updates. See
	 * {@link com.google.appinventor.components.runtime.LocationSensor}.
	 */
	...
	/**
	 * Specifies how a picture is scaled when its dimensions are changed. Choices
	 * are 0 - Scale proportionally, 1 - Scale to fit See
	...
	/**
	 * Choices of theming for App Inventor apps. See
	 * {@link com.google.appinventor.client.editor.youngandroid.properties.YoungAndroidThemeChoicePropertyEditor}
	 */
