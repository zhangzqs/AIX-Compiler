...
public abstract class Compiler {
	...
	/**
	 * 设置编译器的编译等级 Compliance options: use 1.3 compliance (-source 1.3 -target
	 * 1.1) use 1.4 compliance (-source 1.3 -target 1.2) use 1.5 compliance
	 * (-source 1.5 -target 1.5) use 1.6 compliance (-source 1.6 -target 1.6)
	 * use 1.7 compliance (-source 1.7 -target 1.7) use 1.8 compliance (-source
	 * 1.8 -target 1.8) set source level: 1.3 to 1.8 (or 5, 5.0, etc) set
	 * classfile target: 1.1 to 1.8 (or 5, 5.0, etc) cldc1.1 can also be used to
	 * generate the StackMap attribute
	 */
